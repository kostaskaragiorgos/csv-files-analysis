...
class csv_Main():
    def __init__(self,master):
        ...
        self.menu2 = Menu(self.master)
        
        self.file_menu2 = Menu(self.menu2,tearoff = 0)
        self.file_menu2.add_command(label="Exit",accelerator = 'Alt+F4',command = self.exitmenu2)
        self.menu2.add_cascade(label = "File",menu=self.file_menu2)
        
        self.showmenu = Menu(self.menu2,tearoff = 0)
        self.showmenu.add_command(label = "SHOW FIVE FIRST COLUMNS",accelerator = 'Ctrl+F',command = self.show5fcol)
        self.showmenu.add_command(label = "SHOW FIVE LAST COLUMNS",accelerator = 'Ctrl+L',command = self.show5last)
        self.showmenu.add_command(label = "SHOW FROM TO COLUMNS",accelerator = 'Ctrl+T',command= self.showfto)
        self.showmenu.add_command(label = "SHOW INFO",accelerator = 'Alt+I',command= self.showinfobf)
        self.menu2.add_cascade(label = "Show",menu = self.showmenu)
        
        self.about_menu2 = Menu(self.menu2,tearoff = 0)
        self.about_menu2.add_command(label = "About",accelerator = 'Ctrl+I',command=self.aboutmenu2)
        self.menu2.add_cascade(label="About",menu=self.about_menu2)
        
        self.help_menu2 = Menu(self.menu2,tearoff = 0)
        self.help_menu2.add_command(label = "Help",accelerator = 'Ctrl+F1',command=self.helpmenu2)
