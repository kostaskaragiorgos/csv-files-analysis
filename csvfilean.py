...
class csv_Main():
    def __init__(self,master):
        ...
        self.showmenu.add_command(label = "SHOW FIVE FIRST COLUMNS")
        self.showmenu.add_command(label = "SHOW FIVE LAST COLUMNS")
        self.showmenu.add_command(label = "SHOW FROM TO COLUMNS")
        self.showmenu.add_command(label = "SHOW INFO")
